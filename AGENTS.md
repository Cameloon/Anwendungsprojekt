...
### Convex
- **Always read `convex/_generated/ai/guidelines.md`** before writing Convex code (overrides training data)
...
- Setup file: `tests/setup.ts` (mocks localStorage, matchMedia, scrollIntoView)
- No Convex test fixtures currently; tests are frontend-only
